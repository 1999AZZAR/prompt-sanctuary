...
def generate_appropriate_title(filename, category, content):
    ...
    # Define better title mappings based on category and filename
    title_mappings = {
        # Cursor Prompts
        ...
        # Devin AI
        'Prompt': 'Devin AI Software Engineer Assistant',
        ...
        # Replit
        'Prompt': 'Replit AI Assistant Prompt',
        'Tools': 'Replit Tools Configuration',
        
        # VSCode Agent
        'Prompt': 'VSCode Agent Assistant Prompt',
        
        # Trae
        'Chat Prompt': 'Trae Chat Assistant Prompt',
        
        # Same.dev
        'Prompt': 'Same.dev AI Assistant Prompt',
        
        # Lovable
        'Prompt': 'Lovable AI Development Assistant',
        
        # dia
        'Prompt': 'Dia AI Assistant Prompt',
        
        # Manus Agent Tools & Prompt
        'Prompt': 'Manus Agent Main Prompt',
        'Agent Loop': 'Manus Agent Loop Configuration',
        'Modules': 'Manus Agent Modules',
        'Tools': 'Manus Agent Tools Configuration',
        ...
        # Open Source prompts
        'Prompt': 'Open Source AI Assistant Prompt',
    }
